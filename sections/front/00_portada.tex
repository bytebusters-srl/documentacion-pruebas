\begin{titlepage}
    ...
    \begin{center}
        \colorbox{colorPrimario}{%
            \parbox{0.96\textwidth}{\centering
                ...
                DOCUMENTO DE CALIDAD CONTROLADO \quad$\bullet$\quad
    ...
    \begin{center}
        ...
        \vspace{0.35cm}
        {\Huge\bfseries\color{colorPrimario} Documento de Pruebas\par}
        \vspace{0.15cm}
        {\LARGE\bfseries y Validaciones (V\&V)\par}
        \vspace{0.35cm}
        {\large Plataforma \textbf{EthosHub}\par}
        {\normalsize\itshape Verificación y validación del producto a lo largo de cinco sprints\par}
        \vspace{0.3cm}
        \rule{\textwidth}{1.2pt}\par
    \end{center}

    % =====================================================================
    % BLOQUE DE IDENTIFICACIÓN DOCUMENTAL
    % =====================================================================
    \vspace{0.7cm}
    \begin{center}
        ...
        \begin{tabularx}{0.92\textwidth}{|>{\bfseries\color{colorPrimario}}l|X|}
            ...
            \hline
            Norma de referencia & IEEE 1012-2024 \,$\cdot$\, ISO/IEC/IEEE 15289:2024 \\
            \hline
            \rowcolor{grisTecnico}
            Tipo de artefacto & Reporte de verificación y validación (V\&V) \\
            \hline
            \rowcolor{headerTabla}
